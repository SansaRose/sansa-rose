        ...
        <div className="max-w-6xl mx-auto">
                          ...
                          <div className="space-y-3">
                            <div className="bg-gradient-to-r from-yellow-500/10 to-orange-500/10 p-3 rounded-lg border border-yellow-400/20">
                              ...
                              <p className="text-gray-200">
                                If the distance between the two trains or the train and the obstruction, at the time the train or trains have finally come to a stop, is 400 metres or more.
                              </p>
                            </div>
                            <div className="bg-gradient-to-r from-blue-500/10 to-indigo-500/10 p-3 rounded-lg border border-blue-400/20">
                              ...
                              <p className="text-gray-200">
                                If there is an intervening fixed stop signal at danger which is governing the moving train; and compliance by the moving train with the indication conveyed by the fixed stop signal has averted the collision between the trains or between the train and the obstruction.
                              </p>
                            </div>
                          </div>
                        </div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-2 mt-6 border border-white/20">
            <h3 className="lg:text-3xl text-2xl font-bold text-white mb-6 text-center flex flex-col gap-3 items-center justify-center">
              ...
              Averted Collision Criteria
            </h3>
            <div className="flex flex-col gap-3">
              <div className="flex items-start group hover:bg-white/5 lg:p-4 p-2 rounded-lg transition-all duration-300">
                <span className="text-slate-400 mr-4 mt-1 lg:text-2xl text-xl group-hover:scale-110 transition-transform">🚫</span>
                <span className="text-gray-200 lg:text-lg text-base">Vigilance prevents collision</span>
              </div>
              <div className="flex items-start group hover:bg-white/5 lg:p-4 p-2 rounded-lg transition-all duration-300">
                <span className="text-yellow-400 mr-4 mt-1 lg:text-2xl text-xl group-hover:scale-110 transition-transform">📏</span>
                <span className="text-gray-200 lg:text-lg text-base">400m+ distance outside station</span>
              </div>
              <div className="flex items-start group hover:bg-white/5 lg:p-4 p-2 rounded-lg transition-all duration-300">
                <span className="text-blue-400 mr-4 mt-1 lg:text-2xl text-xl group-hover:scale-110 transition-transform">🚦</span>
                <span className="text-gray-200 lg:text-lg text-base">Fixed stop signal compliance</span>
              </div>
            </div>
          </div>
        </div>
