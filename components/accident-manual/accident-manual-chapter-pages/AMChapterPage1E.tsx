      ...
      <div className="relative z-10 py-6 lg:px-4 px-2">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mt-12">
            {/* Definition Card */}
            <div className="bg-linear-to-br from-red-600 to-red-700 rounded-2xl shadow-2xl py-6 px-6 text-white hover:scale-105 transition-all duration-300 group border border-red-400/20">
            ...
            {/* Exclusions Card */}
            <div className="bg-linear-to-br from-orange-600 to-orange-700 rounded-2xl shadow-2xl py-6 px-6 text-white hover:scale-105 transition-all duration-300 group border border-orange-400/20">
