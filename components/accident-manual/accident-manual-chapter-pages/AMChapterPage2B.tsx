        ...
        <div className="max-w-6xl mx-auto">
                    ...
                    <div className="bg-gradient-to-r from-red-500/10 to-orange-500/10 lg:p-6 py-3 lg:px-4 px-2 rounded-xl border border-red-400/20">
                      ...
                      <ul className="space-y-4 text-left mx-auto max-w-4xl text-gray-200 lg:text-lg text-base leading-relaxed">
                        ...
                        <li className="flex items-start gap-3">
                          ...
                          <span>Permanent privation of the sight of either eye.</span>
                        </li>
                        <li className="flex items-start gap-3">
                          <span className="mt-1 text-red-400 font-bold">(c)</span>
                          <span>Permanent privation of the hearing of either ear.</span>
                        </li>
                        <li className="flex items-start gap-3">
                          <span className="mt-1 text-red-400 font-bold">(d)</span>
                          <span>Privation of any member, or joint.</span>
                        </li>
                        <li className="flex items-start gap-3">
                          <span className="mt-1 text-red-400 font-bold">(e)</span>
                          <span>Destruction or permanent impairing of the powers of any member, or joint.</span>
                        </li>
                        <li className="flex items-start gap-3">
                          <span className="mt-1 text-red-400 font-bold">(f)</span>
                          <span>Fracture or dislocation of a bone, or tooth.</span>
                        </li>
                        <li className="flex items-start gap-3">
                          <span className="mt-1 text-red-400 font-bold">(g)</span>
                          <span>Any hurt which endangers life or which causes the sufferer to be in severe body pain or unable to follow his ordinary pursuits for a period of 20 days after the accident.</span>
                        </li>
                      </ul>
                    </div>
                  </div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-2 mt-6 border border-white/20">
            <h3 className="lg:text-3xl text-2xl font-bold text-white mb-6 text-center flex flex-col gap-3 items-center justify-center">
              ...
              Grievous Injury Categories
            </h3>
            <div className="grid lg:grid-cols-2 gap-4">
              <div className="flex items-start group hover:bg-white/5 lg:p-4 p-2 rounded-lg transition-all duration-300">
                <span className="text-red-400 mr-4 mt-1 lg:text-2xl text-xl group-hover:scale-110 transition-transform">👁️</span>
                <span className="text-gray-200 lg:text-lg text-base">Vision loss</span>
              </div>
              <div className="flex items-start group hover:bg-white/5 lg:p-4 p-2 rounded-lg transition-all duration-300">
                <span className="text-red-400 mr-4 mt-1 lg:text-2xl text-xl group-hover:scale-110 transition-transform">👂</span>
                <span className="text-gray-200 lg:text-lg text-base">Hearing loss</span>
              </div>
              <div className="flex items-start group hover:bg-white/5 lg:p-4 p-2 rounded-lg transition-all duration-300">
                <span className="text-red-400 mr-4 mt-1 lg:text-2xl text-xl group-hover:scale-110 transition-transform">🦴</span>
                <span className="text-gray-200 lg:text-lg text-base">Bone fractures</span>
              </div>
              <div className="flex items-start group hover:bg-white/5 lg:p-4 p-2 rounded-lg transition-all duration-300">
                <span className="text-red-400 mr-4 mt-1 lg:text-2xl text-xl group-hover:scale-110 transition-transform">⏰</span>
                <span className="text-gray-200 lg:text-lg text-base">20+ days recovery</span>
              </div>
            </div>
          </div>
        </div>
