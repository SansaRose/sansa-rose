                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-white/5 rounded-lg p-4">
                    <div className="flex items-start gap-4">
                      ...
                      <p className="text-gray-200 lg:text-lg text-base leading-relaxed">
                        <span className="font-semibold text-white">(2)</span> Every order made under this section shall, as soon as may be after it is made, be laid before each House of Parliament.
                      </p>
                    </div>
                  </div>
