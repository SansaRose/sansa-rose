              ...
              <div className="bg-linear-to-br from-purple-500/20 to-pink-500/20 backdrop-blur-lg rounded-xl py-6 lg:px-4 px-2 shadow-lg border border-purple-400/30">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                  ...
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg lg:p-6 p-5 border border-white/20 text-center flex flex-col items-center shadow-lg transition-transform hover:-translate-y-1 hover:shadow-2xl duration-300">
                    <div className="bg-linear-to-br from-purple-500 to-pink-400 text-white font-bold text-2xl lg:text-3xl w-12 h-12 lg:w-16 lg:h-16 flex items-center justify-center rounded-full shadow-lg mb-4 border-4 border-white/30 animate-fade-in">
                      1
                    </div>
                  ...
                  {/* 2. Alert */}
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg lg:p-6 p-5 border border-white/20 text-center flex flex-col items-center shadow-lg transition-transform hover:-translate-y-1 hover:shadow-2xl duration-300">
                    <div className="bg-linear-to-br from-pink-500 to-purple-400 text-white font-bold text-2xl lg:text-3xl w-12 h-12 lg:w-16 lg:h-16 flex items-center justify-center rounded-full shadow-lg mb-4 border-4 border-white/30 animate-fade-in">
                      2
                    </div>
                  ...
                  {/* 3. Secure */}
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg lg:p-6 p-5 border border-white/20 text-center flex flex-col items-center shadow-lg transition-transform hover:-translate-y-1 hover:shadow-2xl duration-300">
                    <div className="bg-linear-to-br from-purple-600 to-pink-600 text-white font-bold text-2xl lg:text-3xl w-12 h-12 lg:w-16 lg:h-16 flex items-center justify-center rounded-full shadow-lg mb-4 border-4 border-white/30 animate-fade-in">
                      3
                    </div>
                  ...
                  {/* 4. Communicate */}
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg lg:p-6 p-5 border border-white/20 text-center flex flex-col items-center shadow-lg transition-transform hover:-translate-y-1 hover:shadow-2xl duration-300">
                    <div className="bg-linear-to-br from-pink-600 to-purple-600 text-white font-bold text-2xl lg:text-3xl w-12 h-12 lg:w-16 lg:h-16 flex items-center justify-center rounded-full shadow-lg mb-4 border-4 border-white/30 animate-fade-in">
                      4
                    </div>
              ...
              <div className="bg-linear-to-br from-cyan-500/20 to-blue-500/20 backdrop-blur-lg rounded-xl py-6 lg:px-4 px-2 shadow-lg border border-cyan-400/30">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg lg:p-6 p-3 border border-white/20 text-center">
                    <div className="bg-linear-to-r from-cyan-500 to-blue-500 p-3 rounded-full lg:w-16 lg:h-16 w-10 h-10 mx-auto mb-3 flex items-center justify-center">
                  ...
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg lg:p-6 p-3 border border-white/20 text-center">
                    <div className="bg-linear-to-r from-blue-500 to-cyan-500 p-3 rounded-full lg:w-16 lg:h-16 w-10 h-10 mx-auto mb-3 flex items-center justify-center">
                      <Train className="w-8 h-8 text-white" />
                    </div>
                  ...
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg lg:p-6 p-3 border border-white/20 text-center">
                    <div className="bg-linear-to-r from-cyan-600 to-blue-600 p-3 rounded-full lg:w-16 lg:h-16 w-10 h-10 mx-auto mb-3 flex items-center justify-center">
