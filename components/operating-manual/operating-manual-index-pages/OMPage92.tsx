                ...
                <div className="space-y-4">
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg lg:p-6 p-4 border border-white/20">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="bg-linear-to-r from-yellow-500/20 to-orange-500/20 rounded-lg p-4 border border-yellow-400/30">
                ...
                <div className="space-y-4">
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg lg:p-6 p-4 border border-white/20">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="bg-linear-to-r from-red-500/20 to-pink-500/20 rounded-lg p-4 border border-red-400/30">
                        <h6 className="font-semibold text-red-300 mb-2 flex items-center">
                          <Calculator className="w-4 h-4 mr-2" />
                          Scott&apos;s Formula:
                        </h6>
