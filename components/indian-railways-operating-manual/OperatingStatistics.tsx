                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    ...
                    <ul className="ml-4 space-y-2">
                      <li className="text-blue-50/95 lg:text-sm text-xs">• Quantity</li>
                      <li className="text-blue-50/95 lg:text-sm text-xs">• Distance</li>
                      <li className="text-blue-50/95 lg:text-sm text-xs">• Duration and</li>
                      <li className="text-blue-50/95 lg:text-sm text-xs">• service.</li>
                    </ul>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-blue-50/95 lg:text-base text-sm leading-relaxed mb-3">
                    ...
                    <div className="space-y-4">
                      <div className="bg-white/5 rounded-lg p-3 border border-blue-400/10">
                        <h3 className="text-blue-200 font-semibold mb-2">1. Primary Units:</h3>
                        <ul className="ml-4 space-y-1 text-xs">
                          <li className="text-blue-50/95">(a) Quantity - Expressed as tonnes and number of passenger carried and earnings derived.</li>
                          <li className="text-blue-50/95">(b) Distance - Expressed in kilometres.</li>
                          <li className="text-blue-50/95">(c) Duration- Expressed in minutes, hours &amp; days</li>
                          <li className="text-blue-50/95">(d) Service performed - Expressed in terms of trains, vehicles, wagons Engines.</li>
                        </ul>
                      </div>
                      <div className="bg-white/5 rounded-lg p-3 border border-blue-400/10">
                        <h3 className="text-blue-200 font-semibold mb-2">2. Fundamental Units:</h3>
                        <p className="text-blue-50/95 lg:text-sm text-xs mb-2">
                        ...
                        <ul className="ml-4 space-y-1 text-xs">
                          <li className="text-blue-50/95">• Tonne-kms,</li>
                          <li className="text-blue-50/95">• Passenger kilometres,</li>
                          <li className="text-blue-50/95">• Train-kilometres,</li>
                          <li className="text-blue-50/95">• Wagon-kilometres,</li>
                          <li className="text-blue-50/95">• Engine hours,</li>
                          <li className="text-blue-50/95">• Wagon days etc.</li>
                        </ul>
                      </div>
                      <div className="bg-white/5 rounded-lg p-3 border border-blue-400/10">
                        <h3 className="text-blue-200 font-semibold mb-2">3. Derived Units:</h3>
                        <p className="text-blue-50/95 lg:text-sm text-xs mb-2">
                        ...
                        <ul className="ml-4 space-y-1 text-xs">
                          <li className="text-blue-50/95">(a) Passenger earning (Primary): Passenger carried (Primary = Earning per passenger</li>
                          <li className="text-blue-50/95">(b) Passenger earning (Primary): Passenger kilometres (fundamental) = Earning per passenger kilometre.</li>
                          <li className="text-blue-50/95">(c) Passenger kilometer (fundamental): Number of passenger (Primary) = Average distance travelled by a passenger also called lead of passenger traffic.</li>
                          <li className="text-blue-50/95">(d) Wagon kilometres (fundamental): Wagon days (fundamental) = Wagon kilometres per wagon day.</li>
                        </ul>
                        <p className="text-blue-50/95 lg:text-sm text-xs mt-2">
              ...
              <div className="bg-linear-to-br from-green-500/20 via-emerald-500/15 to-teal-500/10 backdrop-blur-lg rounded-2xl py-8 lg:px-10 px-4 shadow-xl border border-white/10 hover:border-white/20 transition-all duration-300">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    ...
                    <p className="text-green-50/95 lg:text-sm text-xs leading-relaxed mb-2">
                      Operating statistics are broadly be divided into (i) Traffic (ii) Power.(iii) Rolling Stock
                    </p>
                    <ul className="ml-4 space-y-2 text-xs">
                      <li className="text-green-50/95">(ii) The traffic statistics include statistics of wagons loaded, wagon mobility, wagon usage, train loads, train mobility, productive and unproductive services, wagon detention, marshalling yard, terminal goods station and punctuality</li>
                      <li className="text-green-50/95">(iii) The power statistics include engine usage, fuel and energy consumption, and engine failure statistics etc.</li>
                      <li className="text-green-50/95">(iv) Rolling stock holding &amp; availability, repairs&amp; maintenance % age</li>
                    </ul>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                ...
                <div className="space-y-4">
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-orange-50/95 lg:text-base text-sm leading-relaxed">
                      <span className="font-semibold text-orange-200">1.</span> Operating Statistics for the various Indian Railways are issued in the form of various pamphlets published periodically by the Railway Board. Detailed Statistics relating to each division and gauge are contained in various parts of the &apos;Domestic&apos; statistics issued quarterly (Parts, I, II and IIB &amp; C).
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-orange-50/95 lg:text-base text-sm leading-relaxed mb-3">
                      <span className="font-semibold text-orange-200">2.</span> Some of the important statistics include.
                    </p>
              ...
              <div className="bg-linear-to-br from-cyan-500/20 via-blue-500/15 to-indigo-500/10 backdrop-blur-lg rounded-2xl py-8 lg:px-10 px-4 shadow-xl border border-white/10 hover:border-white/20 transition-all duration-300">
                <div className="space-y-6">
                  ...
                  <div className="bg-white/5 rounded-xl p-5 border border-cyan-400/20">
                    ...
                    <ul className="ml-4 space-y-1 text-xs">
                      <li className="text-cyan-50/95">(a) The average speed of trains</li>
                      <li className="text-cyan-50/95">(b) The average length of train run (average load)</li>
                      <li className="text-cyan-50/95">(c) The idle periods provided for in rake links.</li>
                    </ul>
                  ...
                  <div className="bg-white/5 rounded-xl p-5 border border-cyan-400/20">
                    ...
                    <p className="text-cyan-50/95 lg:text-base text-sm leading-relaxed mb-3">
                      <span className="font-semibold text-cyan-200">1.</span> This figure indicates the amount of unproductive service that has to be performed per 100 train kilometres (Passenger including proportion of mixed). Since the amount of shunting to be done on a passenger train depends upon various local factors, the figure will vary from Division to Division and from Railway to Railway, traffic conditions remaining constant, is indicative of wasteful shunting.
                    </p>
                    <p className="text-cyan-50/95 lg:text-base text-sm leading-relaxed mb-3">
                      <span className="font-semibold text-cyan-200">2.</span> The figure is arrived at by multiplying by 100 the quotient of shunting kilometres divided by train kilometres (passenger including proportion of mixed). It can be depicted by formula given below:-
                    </p>
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-white/5 rounded-xl p-5 border border-emerald-400/20">
                    ...
                    <p className="text-emerald-50/95 lg:text-base text-sm leading-relaxed mb-3">
                      <span className="font-semibold text-emerald-200">1.</span> This figure is compiled separately for coal and coke, heavy merchandise and lightmerchandise, thus affording an indication of the extent to which wagon space is utilised by stations from which traffic originates. It is extremely important that wagons be given as full a load as possible because this means economy, in wagon usage and hence engine power and less strain on line and yard capacity. Even a slight improvement in the starting wagon load can mean a tremendous saving to the Railway.
                    </p>
                    <p className="text-emerald-50/95 lg:text-base text-sm leading-relaxed mb-3">
                      <span className="font-semibold text-emerald-200">2.</span> The result is calculated by dividing the number of tonnes loaded by the number of wagons loaded (in terms of four wheelers), CR and TR vans as also wagons used for live stock and departmental purposes, however, are excluded.
                    </p>
                  ...
                  <div className="bg-white/5 rounded-xl p-5 border border-emerald-400/20">
                    ...
                    <p className="text-emerald-50/95 lg:text-base text-sm leading-relaxed mb-3">
                      <span className="font-semibold text-emerald-200">1.</span> This figure is a measure of wagon mobility and indicates the average number of kilometres moved by a wagon, on the average, per day, both loaded and empty journeys being included. Delays in marshalling yards, delays at stations when loading or unloading, delays in clearance from roadside stations, decrease in average speed of goods trains, increase in the number of wagons awaiting repairs, and shorter loads of trains are some of the factors normally responsible for poor mobility.
                    </p>
                    <p className="text-emerald-50/95 lg:text-base text-sm leading-relaxed mb-3">
                      <span className="font-semibold text-emerald-200">2.</span> This result is obtained by dividing wagon kilometres by wagon days which is the product of daily average number of wagons on line and number of days in period.
                    </p>
                    <div className="bg-white/5 rounded-lg p-3 border border-emerald-400/10">
                      <p className="text-emerald-50/95 lg:text-sm text-xs font-mono text-center mb-2">
                        Wagon Kms.
                  ...
                  <div className="bg-white/5 rounded-xl p-5 border border-emerald-400/20">
                    ...
                    <p className="text-emerald-50/95 lg:text-base text-sm leading-relaxed mb-3">
                      <span className="font-semibold text-emerald-200">1.</span> This unit is a measure of the revenue earning work done by the wagons and reflects both mobility and loading. A decrease in this figure may be due interalia to any of the causes which effect the figure of wagon kilometres per wagon day. The proportion of loaded to total wagon kilometer age, the average loaded wagon and the relative amount of heavy and light merchandise carried, are some of the other factors which may effect this figure.
                    </p>
                    <p className="text-emerald-50/95 lg:text-base text-sm leading-relaxed mb-3">
                      <span className="font-semibold text-emerald-200">2.</span> The numerator in this case is the net tonne kilometres (excluding departmental) and the denominator wagon days.
                    </p>
                    <div className="bg-white/5 rounded-lg p-3 border border-emerald-400/10">
                      <p className="text-emerald-50/95 lg:text-sm text-xs font-mono text-center mb-2">
                        Net Tonne kms.
                  ...
                  <div className="bg-white/5 rounded-xl p-5 border border-emerald-400/20">
                    ...
                    <p className="text-emerald-50/95 lg:text-base text-sm leading-relaxed mb-3">
                      <span className="font-semibold text-emerald-200">1.</span> This unit is a good index of wagon utilisation as it refers to the average load of all loaded wagons carried. It suffers from the draw back that it does not directly reflect the performance of the division, gauge or railway to which it applies, as only a proportion of the loaded wagons carried is loaded locally and the balance consists of both received traffic and cross traffic.
                    </p>
                    <p className="text-emerald-50/95 lg:text-base text-sm leading-relaxed mb-3">
                      <span className="font-semibold text-emerald-200">2.</span> For obtaining this figure net tonne kilometres are divided by loaded wagon kilometres, (the figure relating to departmental trains are excluded).
                    </p>
                    <div className="bg-white/5 rounded-lg p-3 border border-emerald-400/10">
                      <p className="text-emerald-50/95 lg:text-sm text-xs font-mono text-center mb-2">
                        Net Tonnes Kms.
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-white/5 rounded-xl p-5 border border-yellow-400/20">
                    ...
                    <p className="text-yellow-50/95 lg:text-base text-sm leading-relaxed mb-3">
                      <span className="font-semibold text-yellow-200">1.</span> This result is calculated separately for &apos;through goods trains&apos; and all goods trains and is arrived at by dividing the total train kilometres by total train engine hours of the concerned service. Detentions to goods trains at roadside stations enter into the calculations and have therefore the effect of bringing down average speeds.
                    </p>
                    ...
                    <p className="text-yellow-50/95 lg:text-base text-sm leading-relaxed mb-2">
                      <span className="font-semibold text-yellow-200">2.</span> Some of the factors on which the average speed of goods trains depends are:
                    </p>
                    <ul className="ml-4 space-y-1 text-xs">
                      <li className="text-yellow-50/95">(a) The proportion of the density of trains to the sectional capacity. The nearer a section is worked to its sectional capacity, the proper the speeds obtained.</li>
                      <li className="text-yellow-50/95">(b) Hauling power of the engines used, quality of coal and quality and adequacy of water supply, standard of maintenance of engines and time taken by loco pilots for loco requirements.</li>
                      <li className="text-yellow-50/95">(c) Loads of trains.</li>
                      <li className="text-yellow-50/95">(d) Condition of rolling stock, particularly the brake power available.</li>
                      <li className="text-yellow-50/95">(e) Standards and maintenance of signalling and interlocking.</li>
                      <li className="text-yellow-50/95">(f) Facilities at watering stations, facilities at roadside stations to complete shunting in the minimum time and shorter block sections which will increase the sectional capacity.</li>
                      <li className="text-yellow-50/95">(g) Engineering restrictions – permanent and temporary gradients and curves.</li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-white/5 rounded-xl p-5 border border-yellow-400/20">
                    ...
                    <ul className="ml-4 space-y-1 text-xs">
                      <li className="text-yellow-50/95">1. The tractive capacity of engines on goods train services.</li>
                      <li className="text-yellow-50/95">2. The gradients on various sections of the line.</li>
                      <li className="text-yellow-50/95">3. The nature of goods carried.</li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-white/5 rounded-xl p-5 border border-yellow-400/20">
                    ...
                    <p className="text-yellow-50/95 lg:text-base text-sm leading-relaxed mb-3">
                      <span className="font-semibold text-yellow-200">1.</span> This figure indicates the amount of non-revenue earning work done per 100 train kilometres (Goods and proportion of mixed). Its value is affected mainly by the load of goods trains, and the amount of terminal work involved.
                    </p>
                    <div className="bg-white/5 rounded-lg p-3 border border-yellow-400/10 mb-3">
                      <p className="text-yellow-50/95 lg:text-sm text-xs font-mono text-center mb-2">
                        Shunting kms. x 100
                    ...
                    <p className="text-yellow-50/95 lg:text-base text-sm leading-relaxed">
                      <span className="font-semibold text-yellow-200">2.</span> However, for the same division or/railway, the pattern of traffic remaining the same, rise in this figure is indicative of wasteful shunting.
                    </p>
                  </div>
                  ...
                  <div className="bg-white/5 rounded-xl p-5 border border-yellow-400/20">
                    ...
                    <ul className="ml-4 space-y-1 text-xs">
                      <li className="text-yellow-50/95">1. Shunting engine hours not using cut down in proportion to the decrease in traffic offering.</li>
                      <li className="text-yellow-50/95">2. Increase in departmental, assistance required, assisting hot required and light engine running.</li>
                      <li className="text-yellow-50/95">3. Decreasing in the average train and or the average speed of goods train.</li>
                      <li className="text-yellow-50/95">4. Decrease in the average starting wagon load or in the wagon loads of wagons received from other divisions.</li>
                      <li className="text-yellow-50/95">5. Increase in the proportion of unbalanced traffic.</li>
                      <li className="text-yellow-50/95">6. The type of traffic carried heavy or light.</li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-white/5 rounded-xl p-5 border border-yellow-400/20">
                    ...
                    <ul className="ml-4 space-y-2 mb-3">
                      <li className="text-yellow-50/95 lg:text-sm text-xs">1. All wagons</li>
                      <li className="text-yellow-50/95 lg:text-sm text-xs">2. Through loaded wagons:</li>
                    </ul>
                    <p className="text-yellow-50/95 lg:text-base text-sm leading-relaxed mb-3">
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-white/5 rounded-xl p-5 border border-indigo-400/20">
                    ...
                    <ul className="ml-4 space-y-1 text-xs mb-3">
                      <li className="text-indigo-50/95">1. The average run of trains.</li>
                      <li className="text-indigo-50/95">2. The average speed of trains.</li>
                      <li className="text-indigo-50/95">3. The engine links</li>
                      <li className="text-indigo-50/95">4. The location of engine shed with respects to the stations which they serve.</li>
                    </ul>
