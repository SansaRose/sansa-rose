                ...
                <div className="space-y-6">
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed">
                      <span className="font-semibold text-green-200">1.</span> Concessionaires have a non-exclusive right to require the Railway Administration to haul the Concessionaire&apos;s Trains subject to the Concessionaire establishing/ensuring access to Rail Terminals and acquiring a minimum number of Wagons including brake vans to form a Block Rake for the commencement of operations and for transportation of containers.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed">
                      <span className="font-semibold text-green-200">2.</span> The term of this Agreement shall be for a period of 20 years starting from the Commercial Operations Date.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed">
                      <span className="font-semibold text-green-200">3.</span> In the event the Concessionaire fails to operate its Container Trains in accordance with the requirements of this Agreement within three (3) years from the date of award of the In Principle Approval, Railway Administration shall have the right to terminate the Agreement.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed mb-2">
                      <span className="font-semibold text-green-200">4.</span> The rights of the Concessionaire shall include the following:
                    </p>
                    <ul className="ml-6 space-y-1">
                      <li className="text-green-50/95 lg:text-sm text-xs leading-relaxed">i) The right to undertake the business of collecting, storing and loading onto Wagons, consignments of goods from any third party;</li>
                      <li className="text-green-50/95 lg:text-sm text-xs leading-relaxed">ii) The right to determine, charge, collect, retain and appropriate all the fees that it charges from the consigners;</li>
                      <li className="text-green-50/95 lg:text-sm text-xs leading-relaxed">iii) The right to obtain access to Rail Terminals and develop, own, operate and maintain Rail Terminals, including inland container depots;</li>
                      <li className="text-green-50/95 lg:text-sm text-xs leading-relaxed">iv) The right to procure and own/lease Wagons and containers.</li>
                    </ul>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed">
                      <span className="font-semibold text-green-200">5.</span> The concessionaire will be responsible for loading and unloading operations at both the origin and destination Rail Terminals
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed">
                      <span className="font-semibold text-green-200">6.</span> The Railway Administration shall haul the Concessionaire Trains on the payment of prevalent haulage charges as notified from time to time. The present haulage charges are contained in Board&apos;s letter no. 2008/TTIII/73/8 dated 1-7-2008.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed">
                      <span className="font-semibold text-green-200">7.</span> The Central Government (Ministry of Railways) shall have the right to specify certain commodities, which ordinarily move in railway wagons in trainload as notified commodities, which may be subjected to different tariff and conditions for haulage. At present as per Board&apos;s letter no. 2008/TTIII/73/8 dated 1-7-2008, carriage of coal, coke, minerals and ores in containers is prohibited.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed">
                      <span className="font-semibold text-green-200">8.</span> The existing incentives/schemes extended to rail customers or that may be introduced in future shall not ipso facto apply to the Concessionaires. Upon request of the Concessionaire(s), Railway administration may consider extending such schemes to the Concessionaire to the extent possible in a non-discriminatory manner.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed">
                      <span className="font-semibold text-green-200">9.</span> All commercial rules like that contained in Commercial Manual, as amended from time to time and as applicable to other freight traffic moving on Indian Railways shall apply to the Container traffic, except rules specially covered in this Agreement in a non-discriminatory manner amongst similarly placed entities.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed">
                      <span className="font-semibold text-green-200">10.</span> It shall be the Concessionaire&apos;s sole responsibility to procure the requisite approval/authority for the Concessionaire&apos;s Train and/or a Railway Administration locomotive to enter into and utilize the origin and destination Rail Terminal(s).
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed">
                      <span className="font-semibold text-green-200">11.</span> Each concessionaire is required to set up two rail linked inland container terminals within three years of obtaining the license to operate or have access to inland container terminals.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed">
                      <span className="font-semibold text-green-200">12.</span> Use of Railway freight terminals (Goods sheds) as Container Rail Terminals (CRT) has been permitted by the Railways in terms of Rates Circular 10 of 2008.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed mb-2">
                      <span className="font-semibold text-green-200">13.</span> Each Rail Terminal, other than a Railway owned Terminal, that is used by the Concessionaire shall conform to the following:
                    </p>
                    <ul className="ml-6 space-y-1">
                      <li className="text-green-50/95 lg:text-sm text-xs leading-relaxed">(i) Each Rail Terminal shall have rail facilities for handling Concessionaire Trains along with locomotive in conformity with siding rules prescribed by Railway Administration from time to time.</li>
                      <li className="text-green-50/95 lg:text-sm text-xs leading-relaxed">(ii) Be equipped with a RDSO approved in-motion weigh bridge of prescribed standards for weighing of Wagons with and without containers of the Concessionaire&apos;s Train.</li>
                      <li className="text-green-50/95 lg:text-sm text-xs leading-relaxed">(iii) Be equipped with TMS and such other facilities as may be required to interface with, and ensure transfer of data online to, FOIS of Railway Administration.</li>
                    </ul>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed">
                      <span className="font-semibold text-green-200">14.</span> The Concessionaire shall declare the weight of each Wagon/container prior to departure of the Concessionaire&apos;s Train.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed">
                      <span className="font-semibold text-green-200">15.</span> The Concessionaire shall procure by way of purchase, lease or hire, Wagons including Brake Vans and Containers required for the purposes of operating the Concessionaire&apos;s Trains. However, till such time as the Concessionaire procures the required Brake Vans, Railway Administration may provide its own Brake Vans (provided they are available), on non-discriminatory basis, at a reasonable charge, notified by the Railway Administration from time to time.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed">
                      <span className="font-semibold text-green-200">16.</span> In the event any of the Wagons of the Concessionaire are lying idle (&quot;Idle Wagons&quot;), the Concessionaire may offer to the Railway Administration or other Concessionaires, use of any such Idle Wagons. However, Railway Administration shall be under no obligation to accept such an offer of the Concessionaire for use of any Idle Wagons and may levy a Stabling Charge as specified.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed">
                      <span className="font-semibold text-green-200">17.</span> In the event of an Emergency, Railway Administration shall have the right, to temporarily assume control and make use of the Wagons of the Concessionaire. For any such Emergency Use, Railway Administration shall pay to the Concessionaire, a reasonable rent/charge to cover the cost of provisions, maintenance and operation of the Wagon.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed">
                      <span className="font-semibold text-green-200">18.</span> The Concessionaire shall at all times conform to the maintenance standards specified by the Railway Administration in accordance with Good Industry Practice for the Concessionaire&apos;s Containers, rail related equipment and tracks.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed">
                      <span className="font-semibold text-green-200">19.</span> The Concessionaire&apos;s Wagons shall be maintained by the Railway Administration in accordance with the maintenance schedule notified by the Railway Administration. Such maintenance shall, inter alia, include intensive examination, routine overhaul (&quot;ROH&quot;) and periodic overhaul (&quot;POH&quot;). The Concessionaire will provide and maintain the requisite Wagon examination facilities(as specified by railway Administration) inside the Rail Terminal and bear a one time capital cost for tools and plants as specified by Railway Administration and approved by RDSO.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed">
                      <span className="font-semibold text-green-200">20.</span> Wagon maintenance charges for maintenance by Railway administration of the Concessionaire&apos;s Wagons shall be included in the Haulage Charges. The present Haulage Charges include 5% thereof by way of maintenance charges.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed">
                      <span className="font-semibold text-green-200">21.</span> Railway Administration shall normally complete the intensive train examination within a period of 6 hours from the time the Concessionaire&apos;s Wagons (in empty Rake formation) are handed over by the Concessionaire for such examination. Provided however, that the minimum interval between two successive Rakes offered for intensive train examination shall be at least 6 hours. Alternatively, the Railway Administration may examine the Concessionaire&apos;s Wagons at suitable point enroute its destination where the facilities for such examination exists. The time stipulated for maintenance shall not be applicable vis-à-vis such Concessionaire&apos;s Wagons that are declared sick during the course of examination and are required to be detached from the Concessionaire&apos;s Train for sick line/ workshop attention.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed">
                      <span className="font-semibold text-green-200">22.</span> In the event of the Railway Administration&apos;s inability to conform to the time schedule specified for intensive train examination, it shall pay to the Concessionaire for every 24 hours of delay (inclusive of initial 6 hours) so caused, an amount equal to the Stabling Charges payable for such period of delay.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed">
                      <span className="font-semibold text-green-200">23.</span> The Concessionaire may undertake maintenance of the Concessionaire&apos;s Wagons through any other entity including the Concessionaire on such terms and conditions as specified by the Railway Administration from time to time provided however, that the maintenance is carried out as per maintenance schedules and various stages of inspection as may be notified by Railway Administration and pre-departure certification of such Wagons shall be issued by the Railway Administration for which the prescribed charges shall be paid by the Concessionaire.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed">
                      <span className="font-semibold text-green-200">24.</span> The Concessionaire shall hand over empty Concessionaire&apos;s Wagons, in rake formation, to Railway Administration for carrying out maintenance as per the schedule specified by the Railway Administration.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed">
                      <span className="font-semibold text-green-200">25.</span> The haulage charges for moving the Wagons, in rake formation, from a Rail Terminal to the workshop/maintenance depot/train examination point of the Railway Administration and back shall be borne by the Railway Administration, provided however, that the scheduled haulage charges shall be payable by the Concessionaire in the event maintenance is carried out by an entity other than the Railway Administration and inspection is carried out by the Railway Administration at the location of maintenance.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed">
                      <span className="font-semibold text-green-200">26.</span> In the event wagon maintenance is undertaken by the Concessionaire, or any other party (other than Railway Administration in accordance with the provisions of this Agreement) a proportionate rebate in haulage charges (equivalent to the built in maintenance charges) shall be given to the Concessionaire.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed">
                      <span className="font-semibold text-green-200">27.</span> Subject to any operational constraints, Railway administration will provide locomotives to haul the Concessionaire&apos;s Trains on a non-discriminatory and non exclusive basis vis-à-vis other Concessionaires only.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed">
                      <span className="font-semibold text-green-200">28.</span> At least four (4) hours prior to the planned departure of Concessionaire&apos;s Train, the Concessionaire shall submit an indent (&quot;Indent for Locomotive&quot;) for supply of locomotive. The existing incentive schemes if any or incentive schemes that may be introduced in future for supply of locomotives may be extended to the Concessionaire&apos;s Trains with suitable modifications such that it is applied in a non discriminatory manner among different concessionaires.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed">
                      <span className="font-semibold text-green-200">29.</span> The Concessionaire may, anytime prior to arrival of a locomotive cancel its Indent provided however, the Concessionaire shall be liable to pay to Railway Administration indent cancellation charges equivalent to one (1) hour Locomotive Detention Charges. In the event, indent for cancellation of locomotive is received by Railway Administration after the loco is dispatched for the Rail Terminal, the Concessionaire in addition to indent cancellation charges, shall also be liable to pay to Railway Administration such charges as may be prescribed by Railway Administration for the infructuous movement of locomotive both ways. Such charges, however, shall not exceed the charges levied for the movement of the locomotive for the distance from the nearest locomotive shed.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed">
                      <span className="font-semibold text-green-200">30.</span> If after arrival of the locomotive at the Rail Terminal from where the train is required to depart, or the Rail Terminal where the train is required to terminate, as the case may be, the Concessionaire&apos;s Train, for whatsoever reason not attributable to Railway Administration, is not attached or detached and released (as the case may be), prior to expiry of the Free Waiting Time of two hours (entry to exit), the Concessionaire shall be liable to pay to Railway Administration, Locomotive Detention Charges for every hour (or part thereof) for which the locomotive is detained beyond the Free Waiting Time. Provided however, if a locomotive is detained for a period of more than eight (8) hours at any Rail Terminal (either the Rail Terminal of origin or of termination, as the case may be), then, without prejudice to the Concessionaire&apos;s liability to pay to Railway Administration the Locomotive Detention Charges, Railway Administration shall have the right, but not the obligation, to withdraw and/remove the locomotive from such Rail Terminal. In case Railway Administration withdraws and/or remove the locomotive from the Rail Terminal after detention of 8 hours, the detention along with movement charges shall be levied without granting any free time. In the event Railway Administration withdraws the locomotive then, the Indent for locomotive shall deemed to have lapsed, with no further effect. These provisions shall also apply to the situation where the locomotive arrives at a Rail Terminal where the train is scheduled to terminate, but is denied entry into such Rail Terminal for reasons attributable to the Concessionaire and /or the Rail Terminal operator.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed">
                      <span className="font-semibold text-green-200">31.</span> Locomotive Detention Charges payable by the Concessionaire for detention of a locomotive beyond the Free Waiting Time shall be at the rates as prescribed for Diesel/Electric Train Engines by the Railway Administration from time to time. The current Locomotive Detention Charges are contained in Rates Circular No. 18 of 2008.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed">
                      <span className="font-semibold text-green-200">32.</span> Railway Administration shall, in the event of delayed supply of locomotive beyond 12 hours from the indented schedule time of departure of the Concessionaire&apos;s Train, be liable to give to the Concessionaire a one time rebate equal to two (2) percent of the haulage charges payable by the Concessionaire for the Booked Route. This rebate shall, however, not be admissible in contingencies such as interruption of traffic due to accidents or any other similar unavoidable reasons beyond the control of Railway Administration.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed">
                      <span className="font-semibold text-green-200">33.</span> Transportation of the Concessionaire&apos;s trains shall be in Block Rakes. In the event a Concessionaire&apos;s Train operates with lesser number of Wagons/Containers than those prescribed in the Block Rakes (&quot;Non-Block Rake Trains&quot;), the haulage charges for such Non-Block Rake Trains shall be recovered on the basis of the minimum composition of Block Rake as specified by Railway Administration. Provided, however, in the event a Concessionaire&apos;s Train has less than half the Wagons required to constitute a Block Rake, the Railway Administration shall have the right to refuse to haul the Concessionaire&apos;s train comprising less than half a Block Rake. The Railway Administration may however, at its sole discretion extend the facility of two point rakes for Container Trains during specified periods and on specified routes.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed">
                      <span className="font-semibold text-green-200">34.</span> The Concessionaire&apos;s Trains to be hauled by Railway Administration pursuant to this Agreement shall be booked by the shortest route possible (the &quot;Booked Route&quot;) and the haulage charges shall be determined with reference to such Booked Route. Provided however, in case of any accident or other operational exigencies on, or affecting, the Booked Routes, Railway Administration shall, in its sole discretion, be entitled to transport the Concessionaire&apos;s Train by an alternative route (&quot;Alternate Route&quot;). The Concessionaire shall be liable to pay haulage charges only for the Booked Route even when Concessionaire&apos;s Train is transported by an Alternate Route. Provided that in case the Concessionaire&apos;s Trains are carried by a longer route in pursuance of the Rationalisation Scheme of MOR (under section 71 of the Railway Act 1989), the Concessionaire shall be liable to pay charges accordingly.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed">
                      <span className="font-semibold text-green-200">35.</span> The Concessionaire shall, at least 7 (seven) days prior to any calendar week in which it proposes to operate any Concessionaire&apos;s Train, inform (&quot;Weekly Advance Scheduling Notice&quot;) Railway Administration of the number of Concessionaire&apos;s Trains, it requires to be moved, the proposed routes and the likely departure dates (&quot;Weekly Advance Schedule&quot;).
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed">
                      <span className="font-semibold text-green-200">36.</span> Notwithstanding anything to the contrary, the Concessionaire shall, at least twenty four (24) hours prior to the day of programmed loading (excluding the day of loading itself) of a Concessionaire&apos;s Train, confirm to Railway Administration the departure schedule of such Concessionaire&apos;s Train, provided that such notices shall not in any way be binding and shall be only indicative of the Concessionaire&apos;s operations schedule for the following week / day.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed">
                      <span className="font-semibold text-green-200">37.</span> Railway Administration shall maintain a level playing field among all Concessionaires and shall devise and implement a transparent and non-discriminatory system for dispatch of Concessionaire&apos;s Trains on a first come first served basis.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed">
                      <span className="font-semibold text-green-200">38.</span> Notwithstanding anything to the contrary contained in the Agreement, dispatch of locomotives and Concessionaire&apos;s Train(s) shall be subject to any operational exigencies and/or system restrictions.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed">
                      <span className="font-semibold text-green-200">39.</span> Railway Administration shall make all efforts to ensure minimum enroute detention of the Concessionaire&apos;s Trains.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed">
                      <span className="font-semibold text-green-200">40.</span> Subject to any operational and capacity restrictions of Railway Administration, there shall be no restriction on the number and frequency of Concessionaire&apos;s Trains that the Concessionaire may require Railway Administration to haul pursuant to this Agreement.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed">
                      <span className="font-semibold text-green-200">41.</span> The Concessionaire may request the Railway Administration to accept, at any time after the departure of a Concessionaire&apos;s Train, the diversion/re-diversion of such Concessionaire&apos;s Train to any other Rail Terminal, in accordance with the various terms and conditions (including but not limited to payment of haulage charges and other charges) and procedures specified by Railway Administration from time to time subject to its operational exigencies and/or for system restrictions. It is clarified that the Railway Administration shall not be under a legal obligation to comply with such request.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-green-50/95 lg:text-base text-sm leading-relaxed mb-2">
                      <span className="font-semibold text-green-200">42.</span> The Concessionaire shall be liable to pay to Railway Administration Stabling Charges, in the following events :
                    </p>
                    <ul className="ml-6 space-y-1">
                      <li className="text-green-50/95 lg:text-sm text-xs leading-relaxed">(i) In case the Concessionaire&apos;s Train suffers detention at the serving station for reasons attributable to the Concessionaire or when the Concessionaire either declines to accept Wagons inside the Rail Terminal, scheduled to be the terminating Rail Terminal or is not in a position to receive placement of subsequent Wagons; or</li>
                      <li className="text-green-50/95 lg:text-sm text-xs leading-relaxed">(ii) In case of non acceptance of trains inside any port by the port authority concerned; or</li>
                      <li className="text-green-50/95 lg:text-sm text-xs leading-relaxed">(iii) At any of the stations en route due to any reason attributable to the Concessionaire.</li>
                      <li className="text-green-50/95 lg:text-sm text-xs leading-relaxed">(iv) Provided however that Stabling Charges shall be levied only where the detention of the Concessionaire&apos;s Train is for a period in excess of 4 hours.</li>
                    </ul>
