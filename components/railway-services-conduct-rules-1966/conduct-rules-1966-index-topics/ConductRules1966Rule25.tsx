            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center">
                <span className="bg-gradient-to-r from-blue-500 to-cyan-500 lg:p-4 p-2 rounded-full mr-4 shadow-lg flex items-center justify-center">
                  <Archive className="lg:w-8 lg:h-8 w-6 h-6 text-white" />
                </span>
                25. Repeal and Savings
              </h2>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                      The Railway Services (Conduct) Rules, 1966, contained in Appendix VI of the Indian Railways Establishment Code, Volume I, shall cease to be in force except as respects things done or omitted to be done.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              ...
              <div className="bg-gradient-to-br from-green-500/20 to-emerald-500/20 backdrop-blur-lg rounded-xl py-6 lg:px-4 px-3 shadow-lg border border-green-400/30">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                      Notwithstanding anything contained in these rules, a railway servant shall be governed by all the administrative instruction that may be issued from time to time in regard to the conduct of railway servants.
                    </p>
                  </div>
                </div>
              </div>
