        ...
        <div className="max-w-4xl mx-auto space-y-12">
          <div className="text-center space-y-6">
            ...
            <h1 className="text-3xl lg:text-5xl font-bold tracking-wide bg-gradient-to-r from-white via-blue-100 to-indigo-200 bg-clip-text text-transparent animate-[fade-in_1s_ease-out_forwards]">
              Protection and working of points of outlying siding.—
            </h1>
          </div>
...
installations and the procedure for working trains into and out of outlying sidings shall be
embodied in the Station Working Rules of the stations controlling the outlying siding.
S.R.3.35.1.2. An ‘S’ marker indicator should be provided for indicating to the Loco Pilot the
position of facing points at the outlying siding.`}
                  </p>
                  <div className="mt-6 flex justify-center">
                    <Image
                      src="/gsr-images/GSRPAGE45.png"
                      alt="S marker indicator specifications"
                      width={418}
                      height={523}
                      className="w-full max-w-xl rounded-xl border border-white/10 shadow-lg shadow-blue-900/40"
                    />
                  </div>
                </div>
              </div>
...
export default GSRChapterPage45A