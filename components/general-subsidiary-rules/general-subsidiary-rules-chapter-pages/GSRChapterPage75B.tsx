...
const GSRChapterPage75B = () => {
  const content = `3.66. Use of warning signals.—
...
3.66.1.1. Recharging facility shall be provided at suitable places at stations/cabins/gate
...
export default GSRChapterPage75B