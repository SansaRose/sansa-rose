    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-indigo-950 to-blue-900 relative overflow-hidden text-white">
      ...
      <div className="relative z-10 py-6 px-3 lg:px-10">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="lg:w-20 lg:h-20 w-12 h-12 rounded-full border border-white/10 bg-gradient-to-br from-blue-700/60 to-indigo-800/60 backdrop-blur">
                    <div className="w-full h-full rounded-full border border-white/20 flex items-center justify-center">
                      <span className="lg:text-2xl text-lg font-bold text-white/80">4.18</span>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div className="absolute -top-4 left-1/2 -translate-x-1/2 flex justify-center">
                    <div className="relative flex items-center justify-center">
                      <div className="lg:w-20 lg:h-20 w-12 h-12 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 shadow-xl shadow-indigo-900/40 flex items-center justify-center">
                        <span className="lg:text-2xl text-lg font-bold text-white/90">4.18</span>
                      </div>
        ...
        4.18 Means of communication.––
                    ...
                    <p className="rounded-2xl border border-white/10 bg-white/5 px-5 py-6 text-base lg:text-lg shadow-lg shadow-blue-900/20">
(1) No passenger train or mixed train shall be despatched from any station, unless every passenger carriage is provided with means by which communication can be made with the Guard or the Loco Pilot.
                    </p>
                    <p className="rounded-2xl border border-white/10 bg-white/5 px-5 py-6 text-base lg:text-lg shadow-lg shadow-blue-900/20">
...
(b) such particular trains as may be exempted under approved special instructions.
                    ...
                    <p className="rounded-2xl border border-white/10 bg-white/5 px-5 py-6 text-base lg:text-lg shadow-lg shadow-blue-900/20">
(3) If a Railway Administration is satisfied that mischievous use of the means of communication referred to in sub-rule (1) is prevalent, it may, notwithstanding anything contained in that sub-rule, direct the disconnection, for the time being, of the means of communication provided in all or any of the passenger carriages in any such train.
                    </p>
                    <p className="rounded-2xl border border-white/10 bg-white/5 px-5 py-6 text-base lg:text-lg shadow-lg shadow-blue-900/20">
(4) A goods vehicle in which passengers are carried is not a &quot;passenger carriage&quot; within the meaning of this rule.
                    </p>
                    <p className="rounded-2xl border border-white/10 bg-white/5 px-5 py-6 text-base lg:text-lg shadow-lg shadow-blue-900/20">
S.R.4.18.1. Whenever the automatic vacuum brake is applied, the Loco Pilot shall bring the train to a stand clear of tunnels, bridges, viaducts, cuttings, catch siding points or other unsuitable place of a similar nature.
                    </p>
                    <p className="rounded-2xl border border-white/10 bg-white/5 px-5 py-6 text-base lg:text-lg shadow-lg shadow-blue-900/20">
S.R.4.18.2.The Guard shall promptly act according to the circumstance of case. If the chain had been pulled for mischief or for insufficient cause, the Guard shall question the occupants of the carriage and try to find out the name and address of the person who used it. He shall also take the names and addresses of the other persons in the compartment and report the matter at the next important station where the train is booked to stop. The Guard shall record the fact in the CTR and also send a special report to the DRM with full details of the use of communication, the name of the passenger, tickets held by him etc.
                    </p>
                  </div>
                </div>
              </div>
...
export default GSRChapterPage101
