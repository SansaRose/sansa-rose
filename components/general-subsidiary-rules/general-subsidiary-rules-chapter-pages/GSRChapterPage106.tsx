    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-indigo-950 to-blue-900 relative overflow-hidden text-white">
      ...
      <div className="relative z-10 py-6 px-3 lg:px-10">
        ...
        4.20. Manning of engine in motion.—
                    ...
                    <p className="rounded-2xl border border-white/10 bg-white/5 px-5 py-6 text-base lg:text-lg shadow-lg shadow-blue-900/20">
(1) Except when otherwise provided by special instructions, no engine shall be allowed to be in motion on any running line unless the Loco Pilot as also the Assistant Loco Pilot are upon it.
                    </p>
                    <p className="rounded-2xl border border-white/10 bg-white/5 px-5 py-6 text-base lg:text-lg shadow-lg shadow-blue-900/20">
(2) Subject to the provision of sub-rule (3), in no circumstances shall a person other than the Loco Pilot or a railway servant duly qualified in all respects, drive an engine on any running line.
                    </p>
                    <p className="rounded-2xl border border-white/10 bg-white/5 px-5 py-6 text-base lg:text-lg shadow-lg shadow-blue-900/20">
