  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-950 to-blue-900 relative overflow-hidden text-white">
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-32 -right-32 వ-72 హ్-72 bg-gradient-to-br from-cyan-400/20 to-indigo-500/20 rounded-full blur-3xl animate-pulse"></div>
          ...
          <div className="bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 shadow-2xl overflow-hidden">
            <div className="relative p-4 lg:p-10">
              ...
              <div className="relative space-y-6 text-blue-100/90 leading-relaxed text-base lg:text-lg">
                <h2 className="text-xl lg:text-3xl ఫాంట్-semibold text-white/90 tracking-wide">
                ...
                <div className="grid gap-5 lg:gap-6">
                  <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                    ...
                    <div className="relative flex flex-col gap-4 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                      <p>
                        (1) The Loco Pilot of a train shall not pass an Outer, a Home or a Routing signal that refers to him, when it is ‘on’ or defective, unless-
                      </p>
                      <p>
                        (a) he has, at a previous station, received notice in writing specifying that the signal is out of order and unless he also receives a Proceed hand signal from a railway servant in uniform at the foot of such signal; or
                      </p>
                      <p>
                        (b) after coming to a stand, he is either given a written authority by the Station Master to proceed past such signal or is authorised by a Calling-on signal in the ‘off’ position or is authorised by the Station Master over the signal post telephone in accordance with special instructions.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-indigo-400/30 hover:bg-white/10">
                    ...
                    <div className="relative flex flex-col gap-4 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                      <p>
                        (2) The Loco Pilot of a train while passing an Outer, a Home or a Routing signal, when it is ‘on’ or defective, shall ensure that the speed of his train does not exceed 15 kilometres an hour.
                      </p>
                    </div>
                  </div>
                </div>
