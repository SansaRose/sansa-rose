...
(1) Unless exempted under approved special instructions, every level
...
S.R.3.34.1. Every Gate Stop signal in non-automatic signalling territory except those
controlling the entry into a railway-cum-road bridge or where there is a bridge between the
gate signal and the gate, shall be provided with a ‘G’ marker in accordance with Rule 3.17(1).
Note: For passing a gate Stop signal at ‘on’, see Rule 3.73.
3.34.2. When a level crossing located in rear of a Home signal at a station equipped with
...
export default GSRChapterPage44B
