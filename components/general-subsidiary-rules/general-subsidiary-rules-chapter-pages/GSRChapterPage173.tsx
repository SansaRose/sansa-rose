                  ...
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 flex justify-center">
                    <div className="relative flex items-center justify-center">
                      <div className="lg:w-20 lg:h-20 w-12 h-12 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 shadow-xl shadow-indigo-900/40 flex items-center justify-center">
                        <span className="lg:text-2xl text-lg font-bold text-white/90">6.08</span>
                      </div>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>If any portion of a train should, while in motion, become detached-</p>
                            <div className="space-y-4 pl-4 border-l-2 border-cyan-400/30 mt-4">
                              <div>
                                <span className="font-semibold text-cyan-200">(a)</span> The Loco Pilot shall use his judgment to keep the front portion in motion, if possible, until the rear portion has been brought to a stand so as to avoid the chance of a collision between the two portions; and sound the prescribed code of whistle to inform the Guard of the parting.
                              </div>
                              <div>
                                <span className="font-semibold text-cyan-200">(b)</span> the Guard or Guards in the rear portion shall-
                                <div className="space-y-2 pl-6 mt-2 border-l-2 border-indigo-400/30">
                                  <div>
                                    <span className="font-semibold text-indigo-200">(i)</span> do all they can to prevent a collision with the front portion, and
                                  </div>
                                  <div>
                                    <span className="font-semibold text-indigo-200">(ii)</span> promptly apply their hand-brakes, where provided, and
                                  </div>
                                </div>
                              </div>
    <div>
                                <span className="font-semibold text-cyan-200">(c)</span> the Loco Pilot of a banking engine, if any, shall bring the rear portion to a stand and sound the prescribed code of whistle to attract the attention of the Loco Pilot in the front portion.
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-indigo-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              As soon as the rear portion of a train has been brought to a stand, the Guard of the train shall protect that portion in accordance with Rule 6.03 both in the front and the rear, and take steps to secure the vehicles in stationary position by pinning down hand brakes and wherever necessary and prescribed by special instructions by use of sprags and chains also.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              The Guard shall indicate the parting of the train, by waving in repeated motions a green flag by day, or a white light by night, up and down vertically as high and as low as possible.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-indigo-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              The duties of the Guard specified in this rule shall devolve on the Loco Pilot in the absence of the Guard.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              If the Loco Pilot finds it necessary to proceed to the station ahead, he shall, on approaching the station, give &apos;one long, one short, one long, one short&apos; whistle repeatedly to warn the station staff.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-indigo-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              The Loco Pilot shall act as per the aspect of the signals at gate or station, while proceeding.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              The Station Master shall promptly admit the train into the station on a vacant line, and immediately inform the station in rear and SCOR that the train has parted and that the rear portion may roll back.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-indigo-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              If, however, the rear portion is following the front portion, the Station Master shall place three detonators on the line to attract the Guard&apos;s attention and endeavour to bring it to a stand by the application of wagon brakes or by heaping up earth on the rails or other suitable means or divert it, if possible, to a vacant loop or siding line.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-indigo-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              When a train parts on its journey, the tonnage of the train shall be jointly checked by the Guard and the Loco Pilot and also by the Station Master, where the train is taken in two portions. This information shall be embodied in the accident report.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              If the parted portion / portions cannot be coupled up due to any reason, the procedure for divided train working as per GR 6.09 and SRs there under shall be followed.
                            </p>
                          </div>
                        </div>
                      </div>
...
export default GSRChapterPage173
