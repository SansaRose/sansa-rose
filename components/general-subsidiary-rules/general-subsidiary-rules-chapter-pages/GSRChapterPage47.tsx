...
scheduled in the Working Time Table, even though signals governing departure from the
stations are ‘off’.
S.R.3.37.2. No approach lighted signals are provided on this railway.`}
                  </p>
                </div>
              </div>
            </div>
