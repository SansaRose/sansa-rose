    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-indigo-950 to-blue-900 relative overflow-hidden text-white">
      ...
      <div className="relative z-10 py-6 px-3 lg:px-10">
                  ...
                  <div className="absolute -top-4 left-1/2 -translate-x-1/2 flex justify-center">
                    <div className="relative flex items-center justify-center">
                      <div className="lg:w-20 lg:h-20 w-12 h-12 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 shadow-xl shadow-indigo-900/40 flex items-center justify-center">
                        <span className="lg:text-2xl text-lg font-bold text-white/90">4.13</span>
                      </div>
        ...
        4.13. Limits of speed with engine tender foremost.—
                    ...
                    <p className="rounded-2xl border border-white/10 bg-white/5 px-5 py-6 text-base lg:text-lg shadow-lg shadow-blue-900/20">
(1) (a) A passenger train or a mixed train shall not be drawn outside station limits by a steam engine running tender foremost, except-
                    </p>
                    <p className="rounded-2xl border border-white/10 bg-white/5 px-5 py-6 text-base lg:text-lg shadow-lg shadow-blue-900/20">
...
(ii) in a case of unavoidable necessity, to be established by the Loco Pilot.
                    ...
                    <p className="rounded-2xl border border-white/10 bg-white/5 px-5 py-6 text-base lg:text-lg shadow-lg shadow-blue-900/20">
(b) When any such train is so drawn, the speed shall not exceed 25 kilometres an hour, or such higher speed, not exceeding 40 kilometres an hour, as may be authorised by approved special instructions.
                    </p>
                    <p className="rounded-2xl border border-white/10 bg-white/5 px-5 py-6 text-base lg:text-lg shadow-lg shadow-blue-900/20">
(2) In cases of unavoidable necessity, goods trains may run with steam engines tender foremost at a speed not exceeding 25 kilometres an hour or such higher speed, which shall, in no circumstances, exceed 40 kilometres an hour, as may be laid down by special instructions.
                    </p>
                    <p className="rounded-2xl border border-white/10 bg-white/5 px-5 py-6 text-base lg:text-lg shadow-lg shadow-blue-900/20">
(3) When trains have to be worked with steam engines tender foremost as a regular measure under sub-clause (i) of clause (a) of sub-rule (1) and sub-rule (2), the head light and marker lights as prescribed in Rule 4.14 shall be provided on the tender.
                    </p>
                  </div>
                </div>
              </div>
