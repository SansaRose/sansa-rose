    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-indigo-950 to-blue-900 relative overflow-hidden text-white">
      ...
      <div className="relative z-10 py-6 px-3 lg:px-10">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="lg:w-20 lg:h-20 w-12 h-12 rounded-full border border-white/10 bg-gradient-to-br from-blue-700/60 to-indigo-800/60 backdrop-blur">
                    <div className="w-full h-full rounded-full border border-white/20 flex items-center justify-center">
                      <span className="lg:text-2xl text-lg font-bold text-white/80">4.22</span>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div className="absolute -top-4 left-1/2 -translate-x-1/2 flex justify-center">
                    <div className="relative flex items-center justify-center">
                      <div className="lg:w-20 lg:h-20 w-12 h-12 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 shadow-xl shadow-indigo-900/40 flex items-center justify-center">
                        <span className="lg:text-2xl text-lg font-bold text-white/90">4.22</span>
                      </div>
        ...
        4.22. Riding on engine or tender.––
                    ...
                    <p className="rounded-2xl border border-white/10 bg-white/5 px-5 py-6 text-base lg:text-lg shadow-lg shadow-blue-900/20">
(1) No person other than the engine crew shall be authorised to ride on the engine or tender of a steam locomotive, except in accordance with special instructions.
                    </p>
                    <p className="rounded-2xl border border-white/10 bg-white/5 px-5 py-6 text-base lg:text-lg shadow-lg shadow-blue-900/20">
(2) Except as may be permitted by special instructions, no person other than the engine crew shall be authorised to enter any driving compartment of a single or multiple unit train or a train propelled by electric, diesel or petrol engine.
                    </p>
                    <p className="rounded-2xl border border-white/10 bg-white/5 px-5 py-6 text-base lg:text-lg shadow-lg shadow-blue-900/20">
(3) Nounauthorised person shall manipulate any apparatus contained therein.
                    </p>
                    <p className="rounded-2xl border border-white/10 bg-white/5 px-5 py-6 text-base lg:text-lg shadow-lg shadow-blue-900/20">
S.R.4.22.Following persons may travel in the engine provided they are authorised by &apos;engine pass&apos; or orders –
                    </p>
                    <div className="rounded-2xl border border-white/10 bg-white/5 px-5 py-6 text-base lg:text-lg shadow-lg shadow-blue-900/20 whitespace-pre-wrap font-mono">
...
5 Staff specially authorised by DRM or by special instructions.
                    ...
                    <p className="rounded-2xl border border-white/10 bg-white/5 px-5 py-6 text-base lg:text-lg shadow-lg shadow-blue-900/20">
Note: In any case, there shall not be more than five officials/staff including engine crew at any time on the engine except in emergencies as and when specially required.
                    </p>
                  </div>
                </div>
              </div>
...
export default GSRChapterPage108A
