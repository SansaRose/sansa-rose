                ...
                <div className="group relative flex flex-col gap-6 rounded-xl border border-white/10 bg-gradient-to-br from-slate-900/70 via-slate-950/70 to-blue-950/70 p-5 lg:p-12 transition-all duration-500 hover:border-white/20 hover:bg-gradient-to-br hover:from-slate-900/80 hover:via-indigo-950/80 hover:to-blue-950/80">
                  ...
                  <div className="pt-14 lg:pt-12 space-y-6 text-blue-100/90 leading-relaxed tracking-wide">
                    ...
                    <p className="rounded-2xl border border-white/10 bg-white/5 px-5 py-6 text-base lg:text-lg shadow-lg shadow-blue-900/20 font-semibold">
                      S.R. 4.58.1. When the engine has not cleared the fouling marks, the Loco Pilot shall call the attention of the Station Master by giving three long whistles and at the same time wave a Stop hand signal in both directions. He shall also send his Assistant Loco Pilot to advise the Station Master of the position.
                    </p>
                    <p className="rounded-2xl border border-white/10 bg-white/5 px-5 py-6 text-base lg:text-lg shadow-lg shadow-blue-900/20 font-semibold">
                      S.R. 4.58.2. At stations, the Loco Pilot of the train, unless otherwise indicated, shall bring his engine to a stop as close as possible to the Starter/fouling mark/Stop board to ensure clearing of the fouling mark at the rear end.
                    </p>
                  </div>
                </div>
              </div>
