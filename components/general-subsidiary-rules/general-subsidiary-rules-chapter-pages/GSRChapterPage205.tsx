                  ...
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 flex justify-center">
                    <div className="relative flex items-center justify-center">
                      <div className="lg:w-20 lg:h-20 w-12 h-12 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 shadow-xl shadow-indigo-900/40 flex items-center justify-center">
                        <span className="lg:text-2xl text-lg font-bold text-white/90">9.11</span>
                      </div>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20">
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          <div className="space-y-4 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p><span className="font-semibold text-cyan-300">(1)</span> When a Loco Pilot has to pass an Automatic Stop signal at &apos;on&apos;, he shall stop his train at the next reporting station or cabin as prescribed by special instructions and report particulars of Automatic Stop signals passed at &apos;on&apos; by him.</p>
                            <p><span className="font-semibold text-cyan-300">(2)</span> The Station Master or person in charge of the reporting station or cabin shall promptly report the fact to the signal and operating officials concerned.</p>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="space-y-6 lg:space-y-8">
                        <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                          ...
                          <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                            ...
                            <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                              <p>An automatic Stop signal should be considered to have failed when –</p>
                              <div className="pl-4 space-y-2">
                                <p><span className="font-semibold text-cyan-300">(i)</span> the signal exhibits no aspect at all, or</p>
                                <p><span className="font-semibold text-cyan-300">(ii)</span> the signal displays more than one aspect (bobbing / flickering) etc.</p>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                          ...
                          <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                            ...
                            <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                              <p>Whenever failure of Automatic signal has taken place, the Loco Pilot shall, on approaching the next reporting station, sound the prescribed whistle code and inform the Station Master on duty of failure, giving the number of the signal that has failed and passed by him at &apos;on&apos;.</p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                          ...
                          <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                            ...
                            <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                              <p>For this purpose, the first Block Station in the direction of movement shall be reckoned as the Reporting Station. (S. No. 21 of AS 07 of G&SR 2020).</p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                          ...
                          <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                            ...
                            <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                              <p>The Station Master on receipt of signal failure shall at once advise by telephone the Signal Maintainer concerned, the SCOR and the Station Master in rear, giving the correct number of the signal that has failed duly making suitable entry in the S&T failure register.</p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                          ...
                          <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                            ...
                            <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                              <p>When the Signal Maintainer finds that the failure of signal / signals in the automatic section is likely to last for some time and cause serious delay to trains, he shall advise by telephone the Station Master at the station in rear, JE (Signals) and SCOR concerned.</p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                          ...
                          <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                            ...
                            <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                              <p className="text-yellow-200/80 italic mb-3">(Existing SRs 9.11.6 & 9.11.7 are deleted vide S. No. 22 and 23 of AS 07 of G&SR 2020 and existing SR 9.11.8 is renumbered as 9.11.6 and amended).</p>
                              <p>After the failure has been rectified, the Signal Maintainer shall immediately advise the Station Master on duty at block station, who will inform the SCOR and the Station Master of the station at the other end giving the time at which the failure was rectified (S. No. 24 of AS 07 of G&SR 2020).</p>
                            </div>
                          </div>
                        </div>
                      </div>
...
export default GSRChapterPage205
