                ...
                <div className="grid gap-5 lg:gap-6">
                  <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                    ...
                    <div className="relative flex flex-col gap-4 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                      <p>
                        (1) (a) If a Warner signal on a post by itself or a Distant signal is out of order and cannot be kept in the ‘on’ position, a Stop hand signal shall be shown at the foot of the signal. At night, the light or lights of the signal shall be extinguished and the trainafter being first brought to a stand, may then be hand-signalled past the signal. Advice of the defective signal shall be given to the Loco Pilots of trains at the station in rear warning them to stop at such signal.
                      </p>
                      <p>
                        (b) If a Warner signal placed below a Stop signal becomes defective and cannot be kept in the ‘on’ position, the Stop signal above it shall be treated as defective and by night the light of the Warner signal shall be extinguished.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-indigo-400/30 hover:bg-white/10">
                    ...
                    <div className="relative flex flex-col gap-4 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                      <p>
                        (2) If the Warner or Distant signal of an Intermediate Block Post is defective and cannot be kept in the ‘on’ position, the Intermediate Block Stop signal shall also be kept at ‘on’ and treated as defective and action taken as per Rule 3.75.
                      </p>
                    </div>
                  </div>
                </div>
