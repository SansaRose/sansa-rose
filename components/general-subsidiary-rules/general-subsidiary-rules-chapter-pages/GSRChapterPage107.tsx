    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-indigo-950 to-blue-900 relative overflow-hidden text-white">
      ...
      <div className="relative z-10 py-6 px-3 lg:px-10">
        ...
        4.21. Driving an electric train.—
                    ...
                    <p className="rounded-2xl border border-white/10 bg-white/5 px-5 py-6 text-base lg:text-lg shadow-lg shadow-blue-900/20">
(1) In the case of electric trains, the Loco Pilot shall be in the leading driving compartment when the train is in motion or when the train is standing on any running line except as otherwise prescribed in these rules.
                    </p>
                    <p className="rounded-2xl border border-white/10 bg-white/5 px-5 py-6 text-base lg:text-lg shadow-lg shadow-blue-900/20">
(2) (a) In the case of a single or multiple unit train, if the driving apparatus in the leading driving compartment becomes defective, the train shall bedriven cautiously from the nearest driving compartment which isserviceable; in this event, the Guard shall travel in the leading drivingcompartment and shallconvey the necessary signals to the Loco Pilot, the Guard shall also sound the horn or whistle as necessary and apply the brake in caseofemergency and shall be responsible for stopping thetraincorrectly at signals, stations and obstructions.
                    </p>
                    <p className="rounded-2xl border border-white/10 bg-white/5 px-5 py-6 text-base lg:text-lg shadow-lg shadow-blue-900/20">
(b) In the case of an electric engine, if the leading driving compartment becomes defective, the train shall be driven from the trailing driving compartment by the Assistant Loco Pilot if he is duly qualified to drive; and the Loco Pilot shall remain in the leading driving compartment, and shall be responsible for the correct operation of the train.
                    ...
                    <p className="rounded-2xl border border-white/10 bg-white/5 px-5 py-6 text-base lg:text-lg shadow-lg shadow-blue-900/20">
SR.4.21.1 All the instructions given under GR 4.21(1) & (2) (b) which are applicable to electric engine shall also be applicable for working of trains by Diesel Engines having twin cab.
                    </p>
                    <p className="rounded-2xl border border-white/10 bg-white/5 px-5 py-6 text-base lg:text-lg shadow-lg shadow-blue-900/20">
SR.4.21.2 Assistant Loco Pilots may be allowed to drive the engines/trains on certain sections as specified by the DME/DEE (RS) under direct supervision of a Loco Pilot so that in case of emergency the Assistant Loco Pilot can be authorised to drive the train at a restricted speed not exceeding 40 KMPH up to the nearest point where he can be relieved.
                    </p>
                  </div>
                </div>
              </div>
