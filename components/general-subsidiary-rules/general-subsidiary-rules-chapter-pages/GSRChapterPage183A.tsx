                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            ...
                            <div className="space-y-3 pl-4 border-l-2 border-cyan-400/30 mt-4">
                              <div>
                                <span className="font-semibold text-cyan-200">(a)</span> no train shall be allowed to leave a block station unless Line Clear has been received from the block station in advance, and
                              </div>
                              <div>
                                <span className="font-semibold text-cyan-200">(b)</span> on double lines such Line Clear shall not be given unless the line is clear, not only up to the first Stop signal at the block station at which such Line Clear is given but also for an adequate distance beyond it;
                              </div>
                              <div>
                                <span className="font-semibold text-cyan-200">(c)</span> on single lines such Line Clear shall not be given unless the line is clear of trains running in the same direction, not only up to the first Stop signal at the block station at which such Line Clear is given, but also for an adequate distance beyond it, and is clear of trains running in the direction towards the block station to which such Line Clear is given.
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            ...
                            <div className="space-y-3 pl-4 border-l-2 border-indigo-400/30 mt-4">
                              <div>
                                <span className="font-semibold text-indigo-200">(a)</span> 400 metres in case of two-aspect lower quadrant signalling or two-aspect colour light signalling, and
                              </div>
                              <div>
                                <span className="font-semibold text-indigo-200">(b)</span> 180 metres in case of multiple-aspect signalling or modified lower quadrant signalling.
                              </div>
                            </div>
                          </div>
                        </div>
