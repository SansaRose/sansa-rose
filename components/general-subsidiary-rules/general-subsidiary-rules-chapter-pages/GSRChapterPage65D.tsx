...
const GSRChapterPage65D = () => {
  const content = `3.60. Method of using detonators.—
(1) A detonator when required to be used shall be placed on the rail with
...
export default GSRChapterPage65D