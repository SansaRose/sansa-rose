                ...
                <div className="group relative flex flex-col gap-6 rounded-xl border border-white/10 bg-gradient-to-br from-slate-900/70 via-slate-950/70 to-blue-950/70 p-3 lg:p-10 transition-all duration-500 hover:border-white/20 hover:bg-gradient-to-br hover:from-slate-900/80 hover:via-indigo-950/80 hover:to-blue-950/80">
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 flex justify-center">
                    <div className="relative flex items-center justify-center">
                      <div className="lg:w-20 lg:h-20 w-12 h-12 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 shadow-xl shadow-indigo-900/40 flex items-center justify-center">
                        <span className="lg:text-2xl text-lg font-bold text-white/90">5.23</span>
                      </div>
                  ...
                  <div className="pt-14 lg:pt-10 space-y-6 text-blue-100/90 leading-relaxed tracking-wide">
                    <p className="font-semibold text-lg lg:text-2xl text-white/90">
                      Securing of vehicles at station.—
                    </p>
                    <div className="space-y-6 lg:space-y-8">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-4 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p className="font-semibold text-white/90 mb-3">
                              Action by Station Master / Traffic Staff when vehicles /load/train is to be stabled at station:-
                            </p>
                            <div className="space-y-3 pl-4">
                              <p><span className="font-semibold text-indigo-200">1</span> The vehicles/load/train shall be inside the fouling marks</p>
                              <p><span className="font-semibold text-indigo-200">2</span> The vehicles/load/train be chained and padlocked using at least two chains, one at either end. The padlock keys of the Safety Chains shall be in the personal custody of the Station Master.</p>
                              <p><span className="font-semibold text-indigo-200">3</span> At least four wooden wedges/iron skids be used, two each below the outermost pair of wheels at either end;</p>
                              <p><span className="font-semibold text-indigo-200">4</span> Hand brakes of at least 6 wagons from either end must be fully tightened. If hand brakes of any of the first six wagons at each end cannot be applied, hand brakes of subsequent wagons should be applied till six wagons in total are achieved. In case coaching vehicles are stabled, Guard&apos;s hand brakes in SLR(s) must be applied. The hand brakes must be operated under the personal supervision of the Guard, and in the absence of Guard, by SM/ASM on duty;</p>
                              <p><span className="font-semibold text-indigo-200">5</span> The vehicles of stabled load/train should be coupled together. In case the stabled load has to be split for any reason, each such split part should be treated as a separate load for the purpose of securing;</p>
                              <p><span className="font-semibold text-indigo-200">6</span> The points must be set, clamped and padlocked against the blocked line and towards dead end or trap point (if available). Scotch blocks must be used, if available. The padlock keys shall be in the personal custody of the Station Master.</p>
                              <p><span className="font-semibold text-indigo-200">7</span> Line Block Collars must be placed on relevant signal/ point buttons/slides/ levers etc,</p>
                              <p><span className="font-semibold text-indigo-200">8</span> Remarks should be made in TSR and SM diary in Red ink to the effect that &apos;Line No.____ is blocked and all precautions for securing the load have been taken&apos; as prescribed above;</p>
                              <p><span className="font-semibold text-indigo-200">9</span> After any load/train/loco is stabled, the station master must inform the section controller supported by private number that all laid down precautions for stabling and securing the load/train/loco have been taken.</p>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-4 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p className="mb-3">
                              Additional precautions to be taken while stabling vehicles/load/train at a station with gradient steeper than 1 in 400 may have been prescribed under approved special instructions (by CRS) and mentioned in SWR of respective station. These should be followed scrupulously. In addition, following precautions must also be observed over and above those prescribed under approved special instructions:-
                            </p>
                            <div className="space-y-3 pl-4">
                              <p><span className="font-semibold text-cyan-200">1</span> Before vehicles are uncoupled, the hand brakes should be applied, wooden wedges/iron skids, should also be used to prevent vehicles from rolling down;</p>
                              <p><span className="font-semibold text-cyan-200">2</span> As far as possible, the vehicles/load/train should be stabled on a line which is isolated from other lines, particularly running lines.</p>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-indigo-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-4 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            ...
                            <div className="space-y-3 pl-4">
                              <p><span className="font-semibold text-indigo-200">1</span> Application of both SA-9 and A-9 brakes;</p>
                              <p><span className="font-semibold text-indigo-200">2</span> Application of hand brake and parking brake;</p>
                              <p><span className="font-semibold text-indigo-200">3</span> Secure the loco with wooden wedges/iron skids provided on the loco;</p>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              Loco Pilot while on duty should not leave loco unmanned. In case he is required to leave the locomotive unmanned, he should do so only after receiving written authority from the Station Master/Yard Master and ensuring 3 (3.1), (3.2) & (3.3) above;
                            </p>
                          </div>
                        </div>
                      </div>
...
export default GSRChapterPage150B