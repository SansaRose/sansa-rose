                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            ...
                            <div className="space-y-3 pl-4 border-l-2 border-cyan-400/30 mt-4">
                              ...
                              <div>
                                <span className="font-semibold text-cyan-200">(b)</span> all signals have been put back to &apos;on&apos; behind the said train;
                              </div>
                              <div>
                                <span className="font-semibold text-cyan-200">(c)</span> the line on which it is intended to receive the incoming train is clear up to the Starter; and
                              </div>
                              <div>
                                <span className="font-semibold text-cyan-200">(d)</span> all points have been correctly set and all facing points have been locked for the admission of the train on the said line.
                              </div>
                            </div>
                          </div>
                        </div>
