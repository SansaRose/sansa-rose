        ...
        <div className="max-w-7xl mx-auto">
              ...
              <div className="bg-gradient-to-br from-blue-500/20 to-cyan-500/20 backdrop-blur-lg rounded-xl py-6 lg:px-4 px-3 shadow-lg border border-blue-400/30 mb-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="text-gray-200 lg:text-lg text-base leading-relaxed">
                    <span className="font-semibold text-cyan-200">(1)</span> The President or any other authority empowered by him, by general or special order, may -
                    <div className="mt-4 ml-8 space-y-3">
                      <div className="flex items-start gap-3">
                        <span className="font-semibold text-cyan-200">(a)</span>
                        <span>institute disciplinary proceedings against any Railway servant;</span>
                      </div>
                      <div className="flex items-start gap-3">
                        <span className="font-semibold text-cyan-200">(b)</span>
                        <span>direct a disciplinary authority to institute disciplinary proceedings against any Railway servant on whom that disciplinary authority is competent to impose, under these rules, any of the penalties specified in Rule 6.</span>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="text-center mt-12">
            ...
            <p className="text-gray-300">
              Disciplinary & Appeal Rules - Part III, Rule 8
            </p>
          </div>
        </div>
      </div>
