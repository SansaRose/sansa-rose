        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              ...
              <div className="bg-gradient-to-br from-blue-500/20 to-cyan-500/20 backdrop-blur-lg rounded-xl py-6 lg:px-4 px-3 shadow-lg border border-blue-400/30 mb-6">
                <div className="flex items-start gap-4">
                  ...
                  <span className="text-gray-200 lg:text-lg text-base leading-relaxed">
                    <span className="font-semibold text-cyan-200">(1)</span> The President may impose any of the penalties specified in Rule 6 on any Railway servant.
                  </span>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 backdrop-blur-lg rounded-xl py-6 lg:px-4 px-3 shadow-lg border border-purple-400/30 mb-6">
                <div className="flex items-start gap-4">
                  ...
                  <span className="text-gray-200 lg:text-lg text-base leading-relaxed">
                    <span className="font-semibold text-purple-200">(2)</span> Without prejudice to the provisions of sub-rule (1), any of the penalties specified in Rule 6 may be imposed on a Railway servant by the authorities specified in Schedules I, II and III.
                  </span>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-green-500/20 to-emerald-500/20 backdrop-blur-lg rounded-xl py-6 lg:px-4 px-3 shadow-lg border border-green-400/30">
                <div className="flex items-start gap-4">
                  ...
                  <span className="text-gray-200 lg:text-lg text-base leading-relaxed">
                    <span className="font-semibold text-green-200">(3)</span> The disciplinary authority in the case of a Railway servant officiating in a higher post, shall be determined with reference to the officiating post held by him at the time of taking action.
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="text-center mt-12">
            ...
            <p className="text-gray-300">
              Disciplinary & Appeal Rules - Part III, Rule 7
            </p>
          </div>
        </div>
      </div>
