        ...
        <div className="max-w-7xl mx-auto">
                  ...
                  <div className="text-gray-200 lg:text-lg text-base leading-relaxed space-y-3">
                    ...
                    <div className="ml-4 space-y-2">
                      <div className="flex items-start gap-2">
                        ...
                        <span>Secretary, Railway Board/ Joint Secretary/Deputy Secretary.</span>
                      </div>
                      <div className="flex items-start gap-2">
                        <span className="text-purple-200 font-semibold">(ii)</span>
                        <span>Executive Director /Director/ Joint Director.</span>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="text-center mt-12">
            ...
            <p className="text-gray-300">
              Disciplinary & Appeal Rules - Part VII, Rule 26 & 26-A
            </p>
          </div>
        </div>
      </div>
