              ...
              <div className="bg-linear-to-br from-green-500/20 to-emerald-500/20 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-green-400/30">
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <span className="text-gray-200">When the train is stationary at station and the formation (rake) main doors are in open condition, the formation brakes are applied by dropping BP pressure through a door system brake line solenoid valve in LWLRRM coaches and the train cannot be moved.</span>
                  </div>
                  <div className="flex items-start">
                    <span className="text-green-400 mr-3 mt-1 font-bold">2.</span>
                    <span className="text-gray-200">Before departure, the On duty Train Manager of the train has to close the formation main doors through Master door controller, then only the formation brakes are released after closing of all doors, and train can be moved.</span>
                  </div>
                  <div className="flex items-start">
                    <span className="text-green-400 mr-3 mt-1 font-bold">3.</span>
                    <span className="text-gray-200">If because of any reason any of the door is not closed, the mechanical isolating cock provided in front of the door system brake line solenoid valve in LWLRRM to be closed. Then the formation brakes are released and train can be started.</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="bg-linear-to-br from-purple-500/20 to-pink-500/20 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-purple-400/30">
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <span className="text-gray-200">After giving CLOSE command in the door controller by the On duty Train Manager, there will be audio indication for 15 seconds and afterwards the doors will CLOSE in 4 to 6 seconds. It takes 19 to 21 seconds for complete closing of the doors after giving the close command and 15 to 20 seconds for releasing of the entire formation brakes. Altogether, it takes 34 to 41 seconds from giving door close command to complete releasing of formation brakes.</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="bg-linear-to-br from-orange-500/20 to-red-500/20 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-orange-400/30">
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <span className="text-gray-200">When the train speed is above 5 kmph, the Emergency push buttons provided inside and outside of the main doors get isolated and the doors cannot be opened.</span>
                  </div>
                  <div className="flex items-start">
                    <span className="text-orange-400 mr-3 mt-1 font-bold">6.</span>
                    <span className="text-gray-200">In case of any emergency, for opening of main doors, first the train has to be stopped by ACP and then Emergency push buttons can be pressed and doors can be opened.</span>
                  </div>
                  <div className="flex items-start">
                    <span className="text-orange-400 mr-3 mt-1 font-bold">7.</span>
                    <span className="text-gray-200">Similarly, after giving OPEN command in the door controller by the On duty Train Manager, there will be audio indication for 15 seconds and afterwards the doors will OPEN in 4 to 6 seconds. It takes 19 to 21 seconds for complete OPENING of the doors after giving the OPEN command.</span>
                  </div>
                </div>
              </div>
            </div>
