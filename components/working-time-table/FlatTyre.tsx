        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-lg shadow-2xl py-6 px-2 mb-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
            ...
            <div className="space-y-4">
              <div className="flex items-start group hover:bg-white/10 rounded-lg p-3 transition-all duration-300">
                ...
                <span className="text-gray-200">The Loco-Pilot and Guard should be vigilant in detection of unusual/hammering sound in the formation.</span>
              </div>
              <div className="flex items-start group hover:bg-white/10 rounded-lg p-3 transition-all duration-300">
                <span className="text-blue-400 mr-3 mt-1 text-lg group-hover:scale-110 transition-transform">•</span>
                <span className="text-gray-200">TXR staff during &apos;rolling-in&apos; examination at all major train examination points to detect flat face on wheel tyre in train while in motion. Such a wagon in a motion train can be located by them as per procedure given below;</span>
              </div>
              <div className="flex items-start group hover:bg-white/10 rounded-lg p-3 transition-all duration-300">
                <span className="text-blue-400 mr-3 mt-1 text-lg group-hover:scale-110 transition-transform">•</span>
                <span className="text-gray-200">Station Operating Staff while exchanging &apos;all-right&apos; signals shall be vigilant and attentive to hear any unusual / hammering sound in the running train and make efforts to stop and examine the train. If they hear such sound, they should start counting the location of such a wagon (counting it as one) till the BV. It will demarcate location of such a wagon in moving train and communicate it to control and next station.</span>
              </div>
              <div className="flex items-start group hover:bg-white/10 rounded-lg p-3 transition-all duration-300">
                <span className="text-blue-400 mr-3 mt-1 text-lg group-hover:scale-110 transition-transform">•</span>
                <span className="text-gray-200">Traffic & Engineering Gatemen shall also be vigilant in detecting any unusual / hammering sound on a running train and they should be in readiness to exhibit STOP hand signal and stop the train; or intimate the SM if they failed to stop train. Such a wagon in moving train can be located by them as per procedure given above;</span>
              </div>
              <div className="flex items-start group hover:bg-white/10 rounded-lg p-3 transition-all duration-300">
                <span className="text-blue-400 mr-3 mt-1 text-lg group-hover:scale-110 transition-transform">•</span>
                <span className="text-gray-200">Engineering Staff and Supervisors while at worksites or while doing trolley inspection or footplate inspection should also be advised to be vigilant towards detection of flat-tyre on the passing train/s and take suitable action for stopping the train or informing the train Crew / SM by the quickest means of communication available. Such a wagon in moving train can be located by them as per procedure given above;</span>
              </div>
              <div className="flex items-start group hover:bg-white/10 rounded-lg p-3 transition-all duration-300">
                <span className="text-blue-400 mr-3 mt-1 text-lg group-hover:scale-110 transition-transform">•</span>
                <span className="text-gray-200">On-board staff like TTEs, Coach Attendants, AC Mechanics and other Supervisor / Officers travelling by the train can also detect any unusual / hammering sound in the coach / train.</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-lg shadow-2xl py-6 px-2 mb-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white/10 backdrop-blur-lg rounded-lg shadow-2xl py-6 px-2 mb-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
                <h3 className="lg:text-2xl text-xl font-bold text-white mb-4">1.0 Loco Pilot & Guard of the train:</h3>
              ...
              <div className="bg-white/10 backdrop-blur-lg rounded-lg shadow-2xl py-6 px-2 mb-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
                <h3 className="lg:text-2xl text-xl font-bold text-white mb-4">2.0 Mechanical (C&W) Staff:</h3>
                <div className="bg-linear-to-br from-red-500/20 to-pink-500/20 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-red-400/30">
                  <p className="text-gray-200 leading-relaxed">
              ...
              {/* 3.0 Operating Staff */}
              <div className="bg-white/10 backdrop-blur-lg rounded-lg shadow-2xl py-6 px-2 mb-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
                <h3 className="lg:text-2xl text-xl font-bold text-white mb-4">3.0 Operating Staff:</h3>
                <div className="bg-linear-to-br from-red-500/20 to-pink-500/20 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-red-400/30">
                  <p className="text-gray-200 leading-relaxed">
                    Once report about hammering sound is reported in the train from the SM in rear or by any Gateman from the rear block section, the SM shall definitely stop the train. Arrange to issue a memo to the TXR staff if available; to measure the length of flatness and allow the train further only if the measured flat is within the permissible limits. If no TXR staff is posted to work at that station, the SM shall take action to detach the coach/wagon in consultation with Control and allow the remaining train to proceed with normal speed. Under no circumstances, ASM shall allow the train to run with a suspected flat tyre, once the information is received.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-lg rounded-lg shadow-2xl py-6 px-2 mb-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
                <h3 className="lg:text-2xl text-xl font-bold text-white mb-4">4.0 Functions of Control Office:</h3>
                <div className="bg-linear-to-br from-red-500/20 to-pink-500/20 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-red-400/30">
                  <p className="text-gray-200 leading-relaxed">
                    The SCOR after getting information from the SM, shall stop the train at the next immediate station duly taking the advice seriously as reported by stations and advice Deputy Controller and Chief Controller. He shall take action as stated in Para 1.0 & Para 3.0 in consultations with LP, Guard & ASM. Deputy Controller shall co-ordinate with Engineering Control and depute the SSE (P. Way) / JE/P. Way / P. Way Supervisor of Engineering Department to inspect the rear block section either by travelling in a light engine / Tower Car with a restricted speed of 30 KMPH or by proceeding on a motor / push trolley if Loco/Tower car is not readily available or arranging the same is likely to take more time.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-lg rounded-lg shadow-2xl py-6 px-2 mb-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
                <h3 className="lg:text-2xl text-xl font-bold text-white mb-4">5.0 Engineering Staff:</h3>
                <div className="bg-linear-to-br from-red-500/20 to-pink-500/20 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-red-400/30">
                  <p className="text-gray-200 leading-relaxed">
              ...
              <div className="bg-white/10 backdrop-blur-lg rounded-lg shadow-2xl py-6 px-2 mb-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
                <h3 className="lg:text-2xl text-xl font-bold text-white mb-4">6.0 Engineering Control:</h3>
                <div className="bg-linear-to-br from-red-500/20 to-pink-500/20 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-red-400/30">
                  <p className="text-gray-200 leading-relaxed">
                    Engineering control shall co-ordinate with Traffic Control in alerting SSE/JE/P.Way Supervisor of Engineering department and getting the section inspected by Engineering official as laid down in Para 4.0 and 5.0 above. Thereafter, engineering control in consultation with SSE/JEP. Way Supervisor who has inspected the section shall impose SR of 50 KMPH for Passenger trains as well as for empty Goods trains in the affected section till USFD in the affected section (point of detection of unusual sound to next station) is completed and protective action thereafter is taken. No loaded goods train shall be allowed to run unless USFD testing is completed. Adequate number of Ultrasonic teams for checking the affected section shall be arranged, if required by pooling them from other Divisions so as to complete testing within the earliest possible time. On completion of USFD testing, speed of passenger trains and that of empty goods trains shall be raised to 75 KMPH and after observing for 24 hours, normal sectional speed shall be restored for these trains. Loaded goods shall be permitted at 50 KMPH on completion of USFD and after observing for 24 hours, normal speed shall be restored for such trains.
                  </p>
                </div>
              </div>
            </div>
