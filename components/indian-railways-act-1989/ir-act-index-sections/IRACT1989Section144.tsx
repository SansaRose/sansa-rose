                ...
                <div className="space-y-4">
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 hover:bg-white/10 transition-all duration-300 border border-white/10">
                    <div className="flex-1 space-y-4">
                      ...
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        (3) Any person referred to in sub-section (1) or sub-section (2) may be removed from the railway carriage or any part of the railway or railway station, as the case may be, by any railway servant authorized in his behalf or by any other person whom such railway servant may call to his aid.
                      </p>
                    </div>
                  </div>
