                  ...
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 hover:bg-white/10 transition-all duration-300 border border-white/10">
                    <div className="flex-1 space-y-4">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        <span className="font-semibold">(1)</span> subject to rules as may be made, the rates of compensation payable in respect of any injury shall be determined by the Claims Tribunal.
                      </p>
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        <span className="font-semibold">(2)</span> The compensation payable in respect of any loss of goods shall be such as the Claims Tribunal may, having regard to the circumstances of the case, determine to be reasonable.
                      </p>
                    </div>
                  </div>
