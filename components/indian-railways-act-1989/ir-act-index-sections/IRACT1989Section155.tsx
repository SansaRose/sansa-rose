                  ...
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 hover:bg-white/10 transition-all duration-300 border border-white/10">
                    <div className="flex-1 space-y-4">
                      ...
                      <div className="ml-6 space-y-3">
                        ...
                        <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                          (b) having unauthorisedly occupied a berth or seat reserved by a railwy administration for the use of another passenger, refuses to leave it when required to do so by any railway servant authorized in this behalf, such railway servant may remove him or cause him to be removed, with the aid of any other person, from the compartment, berth or seat, as the case may be, and he shall also be punishable with fine which may extend to five hundred rupees.
                        </p>
                      </div>
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        (2) If any passenger resists the lawful entry of another passenger into a compartment not reserved for the use of the passenger resisting, he shall be punishable with the fine which may extend to two hundred rupees.
                      </p>
                    </div>
                  </div>
