              ...
              <div className="bg-gradient-to-br from-blue-500/20 to-cyan-500/20 backdrop-blur-lg rounded-xl py-6 lg:px-4 px-3 shadow-lg border border-blue-400/30">
                <div className="space-y-4">
                  ...
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 hover:bg-white/10 transition-all duration-300 border border-white/10">
                    <div className="flex-1">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        (3) The railway administration may, shall give a notice of not less than seven days of the public auction under Cl. (b) of sub-section (2) in one or ,ore local news papers or where there are no such manner as may be prescribed.
                      </p>
                    </div>
                  </div>
