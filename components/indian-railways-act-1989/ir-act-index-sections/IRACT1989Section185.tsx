                  ...
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 hover:bg-white/10 transition-all duration-300 border border-white/10">
                    <div className="flex-1 space-y-4">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        (1) Notwithstanding anything to the contrary contained in any other law, a railway administration shall not be liable to pay any tax to any local authority in respect of any advertisement made on any part of the railway unless the Central Government, by notification, declary the railway administration to be liable to pay the tax specified in such notification.
                      </p>
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
