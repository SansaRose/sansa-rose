                ...
                <div className="space-y-4">
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 hover:bg-white/10 transition-all duration-300 border border-white/10">
                    <div className="flex-1 space-y-4">
                      ...
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        <span className="font-semibold">(2)</span> The railway administration within whose jurisdiction the accident occurs, as also the railway administration to whom the train involved in the accident belongs, shall without delay, give notice of the accident to the State Government and the Commissioner having jurisdiction over the place of the accident.
                      </p>
                    </div>
                  </div>
