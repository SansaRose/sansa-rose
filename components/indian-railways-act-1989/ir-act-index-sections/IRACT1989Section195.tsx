                ...
                <div className="space-y-4">
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 hover:bg-white/10 transition-all duration-300 border border-white/10">
                    <div className="flex-1 space-y-4">
                      ...
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        (2) A person authorized by a railway administration to conduct prosecution on it s behalf shall, notwithstanding anything in Sec. 302 of the Code of Criminal procedure, 1973 (2 of 1974), be entitled to conduct such prosecution without the permission of the magistrate.
                      </p>
                    </div>
                  </div>
