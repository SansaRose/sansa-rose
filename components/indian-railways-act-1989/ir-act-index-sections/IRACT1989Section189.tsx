                    ...
                    <div className="flex-1 space-y-4">
                      ...
                      <div className="ml-6 space-y-3">
                        <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                          a) purchase or bid for, either in person or by an agent, in his own name or in that of another, or jointly or in shares with others, any property put to auction under sect.83 or sec.84 or sec.85 or sec.90 or
                        </p>
                        <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
