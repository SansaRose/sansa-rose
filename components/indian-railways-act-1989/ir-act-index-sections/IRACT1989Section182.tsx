                ...
                <div className="space-y-4">
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 hover:bg-white/10 transition-all duration-300 border border-white/10">
                    <div className="flex-1 space-y-4">
                      ...
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        (2) Every notification under sub-section (1) shall be published in the official Gazette, and a copy thereof shall be exhibited for the information of the public in some conspicuous place at such railway station as the State Government direct.
                      </p>
                    </div>
                  </div>
