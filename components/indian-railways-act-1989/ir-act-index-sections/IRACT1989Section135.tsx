                  ...
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 hover:bg-white/10 transition-all duration-300 border border-white/10">
                    <div className="flex-1 space-y-4">
                      ...
                      <div className="space-y-3 ml-4">
                        <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                          i. to inspect railways in order to determine whether the provisions of this chapter or of the rules made there under are duly observed; and
                        </p>
                        <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                      ...
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        (3) A supervisor of railway labour shall be deemed to be a Commissioner for the purposes of Secs. 7 and 9.
                      </p>
                    </div>
                  </div>
