          ...
          <div className="space-y-6">
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center">
                ...
                92. Power to make rules in respect of matters in the chapter. –
              </h2>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 hover:bg-white/10 transition-all duration-300 border border-white/10">
                    <div className="flex-1">
                      ...
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed mt-2 ml-4">
                        (c) the form in which a statement a statement is required to be exhibited under sub-section (3) of sec.89.
                      </p>
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed mt-2 ml-4">
                        (d) the manner in which the dates of dates of public auction may be notified under sub-section (1) of Sec. 90 ;
                      </p>
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed mt-2 ml-4">
