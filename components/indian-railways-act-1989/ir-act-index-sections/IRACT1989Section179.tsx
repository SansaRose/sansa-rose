                ...
                <div className="space-y-4">
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 hover:bg-white/10 transition-all duration-300 border border-white/10">
                    <div className="flex-1 space-y-4">
                      ...
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        (2) If any person commits any offence mentioned in Secs. 137, 141 to 147, 153 to 157, 159 to 167, and 172 to 176, he may be arrested without warrant or other written authority by the officer authorised by a notified order of the Central Government.
                      </p>
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        (3) the railway servant or the police officer or the officer authorised, as the case may call to his aid any other person to effect the arrest under sub-section (1).
                      </p>
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        (4) Any person so arrested under this section shall be produced before the nearest Magistrate within a period of twenty-four hours of such arrest excluding the time necessary for the journey from the place or arrest to the court of the Magistrate.
                      </p>
                    </div>
                  </div>
