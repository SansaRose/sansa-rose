...
const IRACT1989Section7 = () => {
  const powers = [
    ...
    {
      label: "(c)",
      content: "require the production of nay book, document or material object belonging to or in the possession or control of nay railway administration which appears to him to be necessary to inspect."
    }
  ]
      ...
      <div className="relative z-10 py-6 lg:px-4 px-2">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-10">
            ...
            <h2 className="lg:text-4xl text-2xl font-bold text-cyan-300 mb-4">Chapter III - COMMISSIONERS OF RAILWAY SAFETY</h2>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center">
                <span className="bg-gradient-to-r from-indigo-500 to-blue-500 lg:p-4 p-2 rounded-full mr-4 shadow-lg flex items-center justify-center">
                  ...
                  {powers.map((power, index) => (
                    <div key={index} className="bg-white/5 backdrop-blur-sm rounded-lg p-4 hover:bg-white/10 transition-all duration-300 border border-white/10">
                      <div className="flex items-start gap-3">
                        <span className="bg-gradient-to-r from-indigo-500 to-blue-500 px-3 py-1 rounded-md text-white font-semibold text-sm flex-shrink-0 mt-1">
                          {power.label}
                        </span>
