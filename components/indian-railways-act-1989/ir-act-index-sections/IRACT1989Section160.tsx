                  ...
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 hover:bg-white/10 transition-all duration-300 border border-white/10">
                    <div className="flex-1 space-y-4">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        (1) if any person, other than a railway servant or a person authorized in this behalf, opens any gate or chain or barrier set up on either side of a level crossing which is closed to road traffic, he shall be punishable with imprisonment for a term which may extend to three years.
                      </p>
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
