          ...
          <div className="space-y-6">
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center">
                ...
                128. Savings as to certain rights
              </h2>
                  ...
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 hover:bg-white/10 transition-all duration-300 border border-white/10">
                    <div className="flex-1 space-y-4">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        <span className="font-semibold">(1)</span> The right of any person to claim compensation under Sce. 124 shall not affect the right of any such person to recover compensation payable under the workmen&apos;s compensation Act, 1923 ,(8 of 1923) or any other law for the time being in force; but no person shall be entitled to claim compensation more than once in respect of the same accident.
                      </p>
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        <span className="font-semibold">(2)</span> Nothing in sub-section (1) shall affect the right of any person to claim compensation payable under any contract or scheme providing for payment of compensation for death or personal injury or for damage to property or any sum payable under any policy of insurance.
                      </p>
                    </div>
                  </div>
